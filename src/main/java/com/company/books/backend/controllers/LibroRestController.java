...
public class LibroRestController {
	...
	public ResponseEntity<LibroResponseRest> update(@RequestBody Libro request, @PathVariable Long id){
		ResponseEntity<LibroResponseRest> response = service.update(request, id);
		return response;
	}
	
	@DeleteMapping("/libros/{id}")
	public ResponseEntity<LibroResponseRest> delete(@PathVariable Long id){
		ResponseEntity<LibroResponseRest> response = service.delete(id);
		return response; 
	}
}
